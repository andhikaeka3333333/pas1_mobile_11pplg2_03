...
class AdapterListTeam extends StatelessWidget {
  final FavoriteController favoriteController = Get.find();
  final TeamModel modelTeam;

  AdapterListTeam({super.key, required this.modelTeam});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      bool isLiked = favoriteController.isFavorite(modelTeam);

      return ItemTeamMobile(
